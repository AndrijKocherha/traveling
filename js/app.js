(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".popular-destination__slider")) new core(".popular-destination__slider", {
        ...
        if (document.querySelector(".planners__swiper") && window.innerWidth >= 992) new core(".planners__swiper", {
            modules: [ Navigation, freeMode ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
        ...
        if (document.querySelector(".galery__slider")) new core(".galery__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
...
***************************************************************************** */
    ...
    document.querySelector("[class*=__container]").offsetWidth;
